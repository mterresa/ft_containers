...
//			std::cout << (*ft_it).first << std::endl;
	...
	}
	{
		...
		bool one = equalBool((*stl_it1).first, (*ft_it1).first);
		...
		bool two = equalBool((*stl_it1).first, (*ft_it1).first);
	...
	/*INSERT*/
	{
		...
		ft_map.insert(ft::pair<int, int>(90, 90));
		ft_map.insert(ft::pair<int, int>(85, 85));
		ft_map.insert(ft::pair<int, int>(200, 200));
		ft_map.insert(ft::pair<int, int>(250, 250));
		ft_map.insert(ft::pair<int, int>(300, 300));
		ft_map.insert(ft::pair<int, int>(77, 77));
	...
	/*EQUAL_RANGE*/
	{
		...
		ft::pair<ft::Map<int,int>::iterator,ft::Map<int,int>::iterator> ft_it = ft_map.equal_range(80);
